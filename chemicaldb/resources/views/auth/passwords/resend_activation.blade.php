...
@section('main-content')
    <div class="card-header">
        <div class="row">
            <div class="col-sm-12">
                <div class="d-flex justify-content-center links"><center><h5>{{ __('Resend Email Activation') }}</h5><center></div>
            </div>
        </div>
    </div>
    <div class="card-body">
        @include('layouts.components.session_message')
        <form method="POST" action="{{ route('activation.resendActivation') }}" id="login-form" style="display: block;">
            @csrf
