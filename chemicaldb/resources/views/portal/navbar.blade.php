...
<body>
<div class="navbars">
    <a href="{{url('/portal')}}"><i class="fa fa-fw fa-home"></i> Laman Utama</a> 
    ...
    <a href="{{url('/')}}"><i class="fa fa-fw fa-user"></i> Log Masuk</a>
    <a href="{{url('/portal')}}#about"><i class="fa fa-user-plus"></i>  Pendaftaran Baru</a>
</div>
</body>
