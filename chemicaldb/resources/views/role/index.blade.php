...
@section('main-content')
    ...
    @push('modals')
        @if(\App\Helpers\PermissionHelper::hasRoleDelete(false))
    ...
    <div class="col-md-12 table-responsive" style="border: none;">
        @component('layouts.components.table_ajax', ['route'=>'role','tname' => 'role_table_ajax','bgColor'=>'bg-red']) 

		@slot('url')
            {{ route('role.indexAjax')}}
        @endslot 
		...
		@slot('tbody')
            @include('layouts.components.datatable_data_card_render_number',['table_name'=>'role_table_ajax']),
            			            @include('layouts.components.datatable_data_card_render', ['table_name'=>'role_table_ajax','name'=>'name','title'=>__('role.name')]),
