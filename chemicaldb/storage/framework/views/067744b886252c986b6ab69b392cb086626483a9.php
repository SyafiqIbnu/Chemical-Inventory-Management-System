	...
	'modelPermitApplication'=>$modelPermitApplication,'canEdit'=>$canEdit]); ?>
		...
		<?php $__env->slot('content'); ?>
			...
			<?php $__env->startComponent('layouts.components.crud_card'); ?>
				...
				<?php echo Form::model($modelPermitApplication, ['route' => ['permit_application.submit', $permit_application_id],'method'=>'PUT','id'=>'permit_application_activityForm']); ?>
					...
					<?php if($completed): ?>
						<?php echo Form::button('<i class="fa fa-check"></i> '.__('general.submit').'',['class'=>'btn btn-primary pull-right','type'=>'submit','id'=>'submitButton']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\permitkhas\resources\views/permit_application/reportsubmit.blade.php ENDPATH**/ ?>