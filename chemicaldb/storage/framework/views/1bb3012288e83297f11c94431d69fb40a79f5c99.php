...
<?php $__env->startSection('main-content'); ?>
    ...
    <div class="col-md-12 table-responsive" style="border: none;">
		...
		<?php $__env->slot('url'); ?>
            <?php echo e(route('permit.indexAjaxSearch')); ?>
		...
		<?php $__env->slot('tbody'); ?>
            ...
            <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'permit_table_ajax','name'=>'permit_no','title'=>__('permit.permit_no')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
                    ...
                    <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'permit_table_ajax','name'=>'active','title'=>__('general.active')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
                    <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'permit_table_ajax','name'=>'permit_status_id','title'=>__('general.status')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\permitkhas\resources\views/permit_search/index.blade.php ENDPATH**/ ?>