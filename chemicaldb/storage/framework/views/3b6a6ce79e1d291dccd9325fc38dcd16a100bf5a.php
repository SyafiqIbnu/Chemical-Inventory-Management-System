    ...
    <div class="col-md-12 table-responsive" style="border: none;">
		...
		<?php $__env->slot('thead'); ?>
            <th style='width: 30px;'><?php echo e(__('general.number')); ?></th>
                        ...
                        <th><?php echo e(__('No Pendaftaran/PBT')); ?></th>
                        <th><?php echo e(__('permit_application.company_name')); ?></th>
                        
                        <th><?php echo e(__('Aktiviti')); ?></th>
                        <th><?php echo e(__('Tarikh Mula Permit')); ?></th>
                        <th><?php echo e(__('Tarikh Tamat Permit')); ?></th>
		...
		<?php $__env->slot('tbody'); ?>
            ...
            <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'permit_application_table_ajax','name'=>'registration_no','title'=>__('No Pendaftaran/PBT')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
            ...
            <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'permit_application_table_ajax','name'=>'activitiy_type_id','title'=>__('Aktiviti')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
            <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'permit_application_table_ajax','name'=>'permit_start_date','title'=>__('Tarikh Mula Permit')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
            <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'permit_application_table_ajax','name'=>'permit_end_date','title'=>__('Tarikh Tamat Permit')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
		...
		<?php $__env->slot('firstScript'); ?>
            <?php if(Auth::user()->can('permit_application_create')): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\permitkhas\resources\views/permit_application/index.blade.php ENDPATH**/ ?>