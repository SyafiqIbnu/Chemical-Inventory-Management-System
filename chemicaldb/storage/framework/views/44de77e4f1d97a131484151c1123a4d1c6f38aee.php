...
<html>
    ...
    <body>
        ...
        <br>
        <br><b><?php echo e(__('general.generated_by')); ?> : </b> <?php if(Auth::check()): ?> <?php echo e(Auth::user()->name); ?> <?php endif; ?>
        <br><b><?php echo e(__('general.generated_date')); ?> : </b> <?php echo date('d/m/Y H:i'); ?>
    </body>
</html><?php /**PATH C:\wamp64\www\bizmillaagent\resources\views/layouts/components/export_pdf.blade.php ENDPATH**/ ?>