<table class="table table-bordered">
                ...
                <?php $bil=0; ?>
                    <?php $__currentLoopData = $permitPurchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $bil++; ?>
                        <?php echo Form::model($modelPermitApplication, ['route' => ['permit_application_purchase.update_belian', $purchase->id],'method'=>'PUT','id'=>'permit_application_activityForm']); ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo Form::text('recommended_quantity',$purchase->recommended_quantity,['class'=>'form-control','id'=>'recommended_quantity','name'=>'recommended_quantity']); ?></td>
            ...
            </table><?php /**PATH C:\wamp64\www\permitkhas\resources\views/permit_application_reviewer/maklumat_belian.blade.php ENDPATH**/ ?>