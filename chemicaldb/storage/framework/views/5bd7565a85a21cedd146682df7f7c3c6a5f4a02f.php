...
<?php $__env->slot('field'); ?>
	<?php echo Form::text('numVehicles',null,['readonly' =>'true','class'=>'form-control','required','placeholder'=>__('booking.numVehicles')]); ?>
...
<?php $__env->slot('field'); ?>
	<?php echo Form::text('costRateVehicles',null,['readonly' =>'true','class'=>'form-control','required','placeholder'=>__('booking.costRateVehicles')]); ?>
...
<?php $__env->slot('field'); ?>
		<?php echo Form::text('delivery_date',null,['class'=>'form-control datetimepicker-input date-field','data-toggle'=>'datetimepicker','id'=>'delivery_date','data-target'=>'#delivery_date','required','placeholder'=>strtoupper(__('booking.delivery_date'))]); ?>
...
<?php /**PATH C:\wamp64\www\factohub\resources\views/booking/create_form.blade.php ENDPATH**/ ?>