    ...
    <div class="col-md-12 table-responsive" style="border: none;">
		...
		<?php $__env->slot('thead'); ?>
            <th style='width: 30px;'><?php echo e(__('general.number')); ?></th>
                        ...
                        <th><?php echo e(__('user.user_type_id')); ?></th>
                        <th><?php echo e(__('user.uid')); ?></th>
                        <th><?php echo e(__('user.email')); ?></th>
                        <th><?php echo e(__('user.mykad')); ?></th>
                        <th><?php echo e(__('user.location_id')); ?></th>
                        <th><?php echo e(__('user.active')); ?></th>
		...
		<?php $__env->slot('tbody'); ?>
            ...
            <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'user_table_ajax','name'=>'user_type_id','title'=>__('user.user_type_id')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
            ...
            <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'user_table_ajax','name'=>'location_id','title'=>__('user.location_id')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
            <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'user_table_ajax','name'=>'active','title'=>__('user.active')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bizmillaagent\resources\views/user/index_all.blade.php ENDPATH**/ ?>