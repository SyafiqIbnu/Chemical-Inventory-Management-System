	...
	<?php $__env->startComponent('layouts.components.crud_card'); ?>
		...
		<?php $__env->slot('cardBody'); ?>
			<?php echo Form::model($modelBookingApplication, ['route' => ['booking_application.update', $modelBookingApplication->id],'method'=>'PUT','id'=>'booking_applicationForm']); ?>
				...
				<?php echo $__env->make('booking_application.show_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		<?php $__env->endSlot(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\factohub\resources\views/booking_application/show.blade.php ENDPATH**/ ?>