...
<div class="col-md-12">
	<div class="card card-primary">
	  <div class="card-header">
		<h3 class="card-title"><?php echo e(__('user.title_customer')); ?></h3>
	  </div>
    ...
    <div class="card-footer">
        ...
        <?php echo Form::button('<i class="fa fa-floppy-o"></i> '.__('general.register').' Pelanggan',['class'=>'btn btn-success pull-right','type'=>'submit','id'=>'submitButton']); ?>
...
<?php echo $__env->make('portal.register', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bizmillaagent\resources\views/user/create_customer.blade.php ENDPATH**/ ?>