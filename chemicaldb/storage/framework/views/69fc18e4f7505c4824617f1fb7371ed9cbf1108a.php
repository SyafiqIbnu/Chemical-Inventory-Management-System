...
<?php $__env->startSection('main-content'); ?>
    ...
    <?php $__env->startComponent('layouts.components.crud_card'); ?>
		...
		<?php $__env->slot('cardBody'); ?>
        <?php echo Form::model($modelOrder, ['route' => ['order.orderreviewed', $modelOrder->id],'method'=>'PUT','id'=>'myForm']); ?>

		<?php echo Form::button('<i class="fa fa-check"></i> '.__('general.review').'',['class'=>'btn btn-warning pull-right','type'=>'submit','id'=>'submitButton']); ?>
		...
		<?php $__env->slot('cardFooter'); ?>
		<a type="button" class="btn btn-primary"	onClick="location.href='<?php echo e(url('orderreviewer')); ?>'"><i class="fa fa-arrow-left"></i>BACK</a>
		<?php $__env->endSlot(); ?>
	<?php echo $__env->renderComponent(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bizmillaagent\resources\views/order/order_review.blade.php ENDPATH**/ ?>