...
<?php $__env->startSection('main-content'); ?>
    ...
    <div class="col-md-12 table-responsive" style="border: none;">
        <?php $__env->startComponent('layouts.components.table_ajax', ['route'=>'account_holder_agency','tname' => 'account_holder_table_ajax','bgColor'=>'bg-red']); ?> 

		<?php $__env->slot('url'); ?>
            <?php echo e(route('account_holder_agency.indexAjax')); ?>
		...
		<?php $__env->slot('thead'); ?>
            ...
            <th style="width:200px;"><?php echo e(__('account_holder.company_name')); ?></th>
                        <th style="width:100px;"><?php echo e(__('account_holder.name')); ?></th>
                        <th><?php echo e(__('account_holder.agency_dept_id')); ?></th>
                        <th><?php echo e(__('account_holder.agency_type_id')); ?></th>
                        <th><?php echo e(__('account_holder.icno')); ?></th>
                        ...
                        <th><?php echo e(__('account_holder.account_application_status_id')); ?></th>
		...
		<?php $__env->slot('tbody'); ?>
            ...
            <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'account_holder_table_ajax','name'=>'company_name','title'=>__('account_holder.company_name')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
                                    ...
                                    <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'account_holder_table_ajax','name'=>'agency_dept_id','title'=>__('account_holder.agency_dept_id')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
                                    <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'account_holder_table_ajax','name'=>'agency_type_id','title'=>__('account_holder.agency_type_id')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
            			            <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'account_holder_table_ajax','name'=>'icno','title'=>__('account_holder.icno')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
                                    ...
                                    <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'account_holder_table_ajax','name'=>'account_application_status_id','title'=>__('account_holder.account_application_status_id')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
    ...
    <?php echo $__env->make('account_holder_agency.menu_active', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\permitkhas\resources\views/account_holder_agency/index.blade.php ENDPATH**/ ?>