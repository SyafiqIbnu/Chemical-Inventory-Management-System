	...
	<?php $__env->startComponent('layouts.components.crud_card'); ?>
		...
		<?php $__env->slot('cardBody'); ?>
			<?php echo Form::model($modelNasiarab, ['route' => ['nasiarab.update', $modelNasiarab->id],'method'=>'PUT','id'=>'nasiarabForm']); ?>
				...
				<?php echo $__env->make('nasiarab.show_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		<?php $__env->endSlot(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bizmillaagent\resources\views/nasiarab/show.blade.php ENDPATH**/ ?>