...
<?php $__env->startSection('main-content'); ?>
    ...
    <?php $__env->startPush('modals'); ?>
        <?php if(Auth::user()->can('delete_role')): ?>
            <?php echo $__env->make('layouts.components.modal_delete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <?php if(Auth::user()->can('create_role')): ?>
            <?php $__env->startComponent('layouts.components.modal_create',['id'=>'modal_create','title'=>'Create','route'=>route('role.store')]); ?> <?php $__env->slot('content'); ?>
                <?php echo $__env->make('role.create_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="col-md-12 table-responsive" style="border: none;">
        <?php $__env->startComponent('layouts.components.table_ajax', ['route'=>'role','tname' => 'role_table_ajax']); ?> 

		<?php $__env->slot('url'); ?>
            <?php echo e(route('role.indexAjax')); ?>
		...
		<?php $__env->slot('tbody'); ?>
            <?php echo $__env->make('layouts.components.datatable_data_card_render_number',['table_name'=>'role_table_ajax'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
            <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'role_table_ajax','name'=>'name','title'=>__('role.name')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
		...
		<?php $__env->slot('firstScript'); ?>
            <?php if(Auth::user()->can('role_create')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bizmillaagent\resources\views/role/index.blade.php ENDPATH**/ ?>