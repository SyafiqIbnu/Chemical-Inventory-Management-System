...
<div class="col-md-12">
	...
	<div class="card-body">
<?php echo Form::model($modelRole, ['route' => ['role.update', $modelRole->id],'method'=>'PUT','id'=>'myAppForm']); ?>

<?php echo $__env->make('role.create_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('role_has_permission.edit_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bizmillaagent\resources\views/role/edit.blade.php ENDPATH**/ ?>