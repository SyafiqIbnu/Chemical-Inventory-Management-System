<?php $__env->startSection('main-content'); ?>
    <div class="card-body">
        ...
        <div class="form-group">       
				<button onclick="window.location='<?php echo e(URL::route('user.create_customer')); ?>'" type="submit" class="button"><?php echo e(__('Daftar Pelanggan')); ?></button>        
        </div>
...
<?php echo $__env->make('portal.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bizmillaagent\resources\views/auth/login.blade.php ENDPATH**/ ?>