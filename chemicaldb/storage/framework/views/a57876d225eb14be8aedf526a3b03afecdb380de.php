...
<?php if(isset($modelUser->id)): ?>
	<?php if($modelUser->user_type_id==2): ?>
		<?php echo $__env->make('user.create_form_user_types_account_holder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	<?php else: ?>
		<?php echo $__env->make('user.create_form_user_types_selection', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	<?php endif; ?>
<?php else: ?>
	<?php echo $__env->make('user.create_form_user_types_selection', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?> 
...
<?php /**PATH C:\wamp64\www\permitkhas\resources\views/user/create_form.blade.php ENDPATH**/ ?>