...
<table class="table table-bordered ">
        ...
        <tbody>
            ...
            <tr>
                ...
                <a  title='Edit' type='button' class='btn btn-xs btn-error' href="<?php echo url('permit_application_usage/'.$permit_application_id.'/index'); ?>"><i class='fa fa-edit'></i></a>
                </td>
...
<table class="table table-bordered ">
        ...
        <tbody>
            ...
            <tr>
                ...
                <a  title='Edit' type='button' class='btn btn-xs btn-error' href="<?php echo url('permit_application_purchase/'.$permit_application_id.'/index'); ?>"><i class='fa fa-edit'></i></a>
                </td>
            </tr>
            <table class="table table-bordered">
                <tbody>
...
</table><?php /**PATH C:\wamp64\www\permitkhas\resources\views/permit_application/maklumat_permit.blade.php ENDPATH**/ ?>