    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <a href="<?php echo e(url('/reportchemical')); ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
                </div>
                ...
                <a href="<?php echo e(url('/report')); ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
                </div>
            </div>
...
<?php /**PATH D:\xampp\htdocs\chemicaldb\resources\views/dashboard.blade.php ENDPATH**/ ?>