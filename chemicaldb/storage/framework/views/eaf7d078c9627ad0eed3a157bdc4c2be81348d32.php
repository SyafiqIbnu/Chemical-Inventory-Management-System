...
<?php $__env->startSection('main-content'); ?>
    ...
    <div class="col-md-12 table-responsive" style="border: none;">
		...
		<?php $__env->slot('url'); ?>
            <?php echo e(route('order.indexAjaxReceive')); ?>
		...
		<?php $__env->slot('thead'); ?>
            <th style='width: 30px;'><?php echo e(__('general.number')); ?></th>
                        ...
                        <th><?php echo e(__('order.bil_pax')); ?></th>
                        
                        <th style="width:80px;"><?php echo e(__('Lihat')); ?></th>
        <?php $__env->endSlot(); ?> 
		...
		<?php $__env->slot('tbody'); ?>
            <?php echo $__env->make('layouts.components.datatable_data_card_render_number',['table_name'=>'order_table_ajax'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
                                    ...
                                    <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'order_table_ajax','name'=>'bil_pax','title'=>__('order.bil_pax')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
    ...
    <?php $__env->startComponent('layouts.components.crud_card'); ?>
        <?php $__env->slot('cardTitle'); ?> <b> MASTER CALCULATION (<?php echo e($todaydate); ?>) </b></br> <?php $__env->endSlot(); ?>
        ...
        <?php $__env->slot('cardBody'); ?>
            <table class="table table-bordered">
                ...
                <tr>
                    <td>AYAM</td>
                    <td><?php echo e($totalayamactual); ?></td>
                    <td><?php echo e($totalayambuffer); ?></td>
                    <td><?php echo e($totalayamraw); ?></td>
                </tr>
                <tr>
                    <td>KAMBING</td>
                    <td><?php echo e($totalkambingactual); ?></td>
                    <td><?php echo e($totalkambingbuffer); ?></td>
                    <td><?php echo e($totalkambingraw); ?></td>
                </tr>
                <tr>
                    <td>PAX(NASI)</td>
                    <td><?php echo e($totalpaxactual); ?></td>
                    <td><?php echo e($totalpaxbuffer); ?></td>
                    <td></td>
                </tr>
                <tr>
                    <td>SIDE CONDIMENT</td>
                    <td><?php echo e($sidecondimentactual); ?></td>
                    <td><?php echo e($sidecondimentbuffer); ?></td>
                    <td></td>
                </tr>
                </tbody>
                </table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bizmillaagent\resources\views/order/index_receive.blade.php ENDPATH**/ ?>