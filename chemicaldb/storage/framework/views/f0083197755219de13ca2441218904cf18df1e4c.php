	...
	<?php $__env->startComponent('layouts.components.crud_card'); ?>
		...
		<?php $__env->slot('cardBody'); ?>
			<?php echo Form::model($modelChemical, ['route' => ['chemical.update', $modelChemical->id],'method'=>'PUT','id'=>'chemicalForm']); ?>
				...
				<?php echo $__env->make('chemical.create_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		<?php $__env->endSlot(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\chemicaldb\resources\views/chemical/edit.blade.php ENDPATH**/ ?>