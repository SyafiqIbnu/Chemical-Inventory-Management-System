...
<?php $__env->startSection('main-content'); ?>
    ...
    <div class="col-md-12 table-responsive" style="border: none;">
		...
		<?php $__env->slot('url'); ?>
            <?php echo e(route('booking_vehicle.indexAjax')); ?>
		...
		<?php $__env->slot('thead'); ?>
            <th style='width: 30px;'><?php echo e(__('general.number')); ?></th>
                        <th><?php echo e(__('booking_vehicle.booking_id')); ?></th>
		...
		<?php $__env->slot('tbody'); ?>
            <?php echo $__env->make('layouts.components.datatable_data_card_render_number',['table_name'=>'booking_vehicle_table_ajax'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
            			            <?php echo $__env->make('layouts.components.datatable_data_card_render', ['table_name'=>'booking_vehicle_table_ajax','name'=>'booking_id','title'=>__('booking_vehicle.booking_id')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>,
		...
		<?php $__env->slot('firstScript'); ?>
            <?php if(Auth::user()->can('booking_vehicle_create')): ?>
    ...
    <?php echo $__env->make('booking_vehicle.menu_active', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\factohub\resources\views/booking_vehicle/index.blade.php ENDPATH**/ ?>