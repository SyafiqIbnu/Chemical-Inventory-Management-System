	...
	<?php $__env->startComponent('layouts.components.crud_card'); ?>
		...
		<?php $__env->slot('cardBody'); ?>
			<?php echo Form::model($modelActitivyType, ['route' => ['actitivy_type.update', $modelActitivyType->id],'method'=>'PUT','id'=>'actitivy_typeForm']); ?>
				...
				<?php echo $__env->make('actitivy_type.show_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		<?php $__env->endSlot(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\permitkhas\resources\views/actitivy_type/show.blade.php ENDPATH**/ ?>